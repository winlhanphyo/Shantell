webpackJsonp([0], [function (t, e, n) {
    ...
    o(),
      ...
      app.els.$body.on("click", ".u-Route", function (e) {
        if (!app.els.$body.hasClass("Custom404Page")) {
          var n = (s.history.getFragment(),
            t(e.currentTarget).attr("href") || t(e.target).closest("a").attr("href"));
      ...
      if (!t[c].parsingSrcset) {
        ...
        if (e)
          ...
          t[c].parsingSrcset = !0,
            ...
            t[r.ns].curSrc || (t[r.ns].supported = !1,
              r.fillImg(t, {
                reselect: !0
              })),
        ...
        t.style.backgroundImage = 'url("' + o + '")',
          ...
          /scale-down/.test(s["object-fit"]) ? (t[c].i || (t[c].i = new Image,
            t[c].i.src = o),
            function e() {
  ...
  , function (t, e, n) {
    ...
    !function (o) {
      var r = !1;
      if (s = o,
        a = "function" == typeof s ? s.call(e, n, e, t) : s,
          ...
          if ("undefined" != typeof document) {
            ...
            for (var p = document.cookie ? document.cookie.split("; ") : [], u = /(%[0-9A-Z]{2})+/g, d = 0; d < p.length; d++) {
              ...
              try {
                ...
                if (f = n.read ? n.read(f, v) : n(f, v) || f.replace(u, decodeURIComponent),
                  this.json)
                  try {
                    f = JSON.parse(f)
                  } catch (t) { }
    ...
    !function (t) {
      ...
      if (!t.jQuery) {
        ...
        n.isWindow = function (t) {
          ...
          ,
          n.extend = function () {
            var t, e, s, a, o, r, c = arguments[0] || {}, i = 1, l = arguments.length, p = !1;
            for ("boolean" == typeof c && (p = c,
              c = arguments[i] || {},
              i++),
              "object" != typeof c && "function" !== n.type(c) && (c = {}),
              i === l && (c = this,
                i--); i < l; i++)
              if (o = arguments[i])
                for (a in o)
                  o.hasOwnProperty(a) && (t = c[a],
                    s = o[a],
                    c !== s && (p && s && (n.isPlainObject(s) || (e = n.isArray(s))) ? (e ? (e = !1,
                      r = t && n.isArray(t) ? t : []) : r = t && n.isPlainObject(t) ? t : {},
                      c[a] = n.extend(p, r, s)) : void 0 !== s && (c[a] = s)));
            return c
          }
          ,
      ...
      function (o) {
        "use strict";
        "object" == typeof t && "object" == typeof t.exports ? t.exports = o() : (s = o,
          a = "function" == typeof s ? s.call(e, n, e, t) : s,
          !(void 0 !== a && (t.exports = a)))
      }(function () {
        "use strict";
        return function (t, e, n, s) {
          ...
          function o(t) {
            return b.isWrapped(t) ? t = w.call(t) : b.isNode(t) && (t = [t]),
              t
          }
          function r(t) {
          ...
          function p(t, n, s, a) {
            ...
            var x = k ? new Float32Array(y) : new Array(y)
              ...
              , j = function (e) {
                return P || f(),
                  t === n && s === a ? e : 0 === e ? 0 : 1 === e ? 1 : i(h(e), n, a)
              };
          ...
          function u(t, e) {
            var n = t;
            return b.isString(t) ? P.Easings[t] || (n = !1) : n = b.isArray(t) && 1 === t.length ? l.apply(null, t) : b.isArray(t) && 2 === t.length ? j.apply(null, t.concat([e])) : !(!b.isArray(t) || 4 !== t.length) && p.apply(null, t),
              !1 === n && (n = P.Easings[P.defaults.easing] ? P.defaults.easing : x),
              n
          }
          function d(t) {
            if (t) {
              ...
              n > 1e4 && (P.State.calls = a(P.State.calls),
                n = P.State.calls.length);
              for (var o = 0; o < n; o++)
                if (P.State.calls[o]) {
                    ...
                    if (r(I)) {
                      ...
                      for (var E in j)
                        if (j.hasOwnProperty(E) && "element" !== E) {
                          var O, N = j[E], V = b.isString(N.easing) ? P.Easings[N.easing] : N.easing;
                      ...
                      l.mobileHA && r(I).transformCache.translate3d === s && (r(I).transformCache.translate3d = "(0px, 0px, 0px)",
                        T = !0),
          ...
          function h(t, e) {
            ...
            for (var n = P.State.calls[t][0], a = P.State.calls[t][1], o = P.State.calls[t][2], c = P.State.calls[t][4], i = !1, l = 0, p = n.length; l < p; l++) {
              var u = n[l].element;
              e || o.loop || ("none" === o.display && S.setPropertyValue(u, "display", o.display),
              ...
              if (!0 !== o.loop && (f.queue(u)[1] === s || !/\.velocityQueueEntryFlag/i.test(f.queue(u)[1])) && d) {
                ...
                f.each(S.Lists.transforms3D, function (t, e) {
                  ...
                  d.transformCache[e] !== s && new RegExp("^\\(" + n + "[^.]").test(a) && (h = !0,
          ...
          var f, v = function () {
            ...
            try {
              ...
              return function (e, n) {
                ...
                var a, o = [], r = e >= 0 ? e : Math.max(0, s + e), c = n < 0 ? s + n : Math.min(n, s), i = c - r;
                if (i > 0)
                  if (o = new Array(i),
                    this.charAt)
                    for (a = 0; a < i; a++)
          ...
          e.pageYOffset !== s ? (P.State.scrollAnchor = e,
          ...
          var S = P.CSS = {
            ...
            Hooks: {
                  ...
                  for (n in S.Hooks.templates)
                    if (S.Hooks.templates.hasOwnProperty(n)) {
                      ...
                      "Color" === a[0] && (a.push(a.shift()),
                        o.push(o.shift()),
                        S.Hooks.templates[n] = [a.join(" "), o.join(" ")])
                    }
                for (n in S.Hooks.templates)
                  if (S.Hooks.templates.hasOwnProperty(n)) {
                    s = S.Hooks.templates[n],
              ...
              cleanRootPropertyValue: function (t, e) {
                return S.RegEx.valueUnwrap.test(e) && (e = e.match(S.RegEx.valueUnwrap)[1]),
              ...
              extractValue: function (t, e) {
                ...
                if (n) {
                  var s = n[0]
                    , a = n[1];
                  return e = S.Hooks.cleanRootPropertyValue(s, e),
                    e.toString().match(S.RegEx.valueSplit)[a]
                }
                return e
              },
              injectValue: function (t, e, n) {
                ...
                if (s) {
                  ...
                  return n = S.Hooks.cleanRootPropertyValue(o, n),
                    a = n.toString().match(S.RegEx.valueSplit),
                    a[r] = e,
                    a.join(" ")
                }
                return n
              ...
              registered: {
                clip: function (t, e, n) {
                  switch (t) {
                    ...
                    case "extract":
                      var s;
                      return S.RegEx.wrappedValueAlreadyExtracted.test(n) ? s = n : (s = n.toString().match(S.RegEx.valueUnwrap),
                        s = s ? s[1].replace(/,(\s+)?/g, " ") : n),
                        s;
                    case "inject":
                      return "rect(" + n + ")"
                  }
              ...
              register: function () {
                function t(t, e, n) {
                  if ("border-box" === S.getPropertyValue(e, "boxSizing").toString().toLowerCase() === (n || !1)) {
                    var s, a, o = 0, r = "width" === t ? ["Left", "Right"] : ["Top", "Bottom"], c = ["padding" + r[0], "padding" + r[1], "border" + r[0] + "Width", "border" + r[1] + "Width"];
                    ...
                    S.Normalizations.registered[t] = function (e, n, a) {
                      switch (e) {
                        ...
                        case "inject":
                          ...
                          return o || (r(n).transformCache[t] = "(" + a + ")"),
                    ...
                    S.Normalizations.registered[t] = function (e, n, a) {
                      switch (e) {
                        ...
                        case "extract":
                          ...
                          return (!v || v > 8) && 3 === o.split(" ").length && (o += " 1"),
                            o;
                        case "inject":
                          return /^rgb/.test(a) ? a : (v <= 8 ? 4 === a.split(" ").length && (a = a.split(/\s+/).slice(0, 3).join(" ")) : 3 === a.split(" ").length && (a += " 1"),
                            (v <= 8 ? "rgb" : "rgba") + "(" + a.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")")
                      }
                    }
                  }();
            ...
            Names: {
              ...
              SVGAttribute: function (t) {
                ...
                return (v || P.State.isAndroid && !P.State.isChrome) && (e += "|transform"),
              ...
              prefixCheck: function (t) {
                ...
                for (var e = ["", "Webkit", "Moz", "ms", "O"], n = 0, s = e.length; n < s; n++) {
                  ...
                  if (a = 0 === n ? t : e[n] + t.replace(/^\w/, function (t) {
                    ...
                    return P.State.prefixMatches[t] = a,
                      [a, !0]
                }
                return [t, !1]
              }
            ...
            Values: {
              hexToRgb: function (t) {
                var e, n = /^#?([a-f\d])([a-f\d])([a-f\d])$/i, s = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i;
            ...
            getPropertyValue: function (t, n, a, o) {
              function c(t, n) {
                ...
                if (v <= 8)
                  ...
                  var i = !1;
                  /^(width|height)$/.test(n) && 0 === S.getPropertyValue(t, "display") && (i = !0,
              ...
              if (S.Hooks.registered[n]) {
                ...
                u = S.Normalizations.registered[n]("name", t),
                  "transform" !== u && (d = c(t, S.Names.prefixCheck(u)[0]),
                    S.Values.isCSSNullValue(d) && S.Hooks.templates[n] && (d = S.Hooks.templates[n][1])),
              ...
              return S.Values.isCSSNullValue(i) && (i = 0),
                P.debug >= 2 && console.log("Get " + n + ": " + i),
                i
            },
            setPropertyValue: function (t, n, s, a, o) {
              ...
              if ("scroll" === n)
                ...
                if (S.Normalizations.registered[n] && (s = S.Normalizations.registered[n]("inject", t, s),
                  n = S.Normalizations.registered[n]("name", t)),
                  c = S.Names.prefixCheck(n)[0],
                  v <= 8)
                  try {
                    t.style[c] = s
                  } catch (t) {
            ...
            flushTransformCache: function (t) {
              ...
              if ((v || P.State.isAndroid && !P.State.isChrome) && n && n.isSVG) {
                ...
                f.each(r(t).transformCache, function (n) {
                  return o = r(t).transformCache[n],
                    "transformPerspective" === n ? (c = o,
                      !0) : (9 === v && "rotateZ" === n && (n = "rotate"),
                        void (e += n + o + " "))
                }),
                  c && (e = "perspective" + c + " " + e)
              }
          ...
          var I = function () {
            ...
            function a(t, a) {
              function o(o) {
                ...
                if ("scroll" === O) {
                  var v, m, M, x = /^x$/i.test(i.axis) ? "Left" : "Top", I = parseFloat(i.offset) || 0;
                  i.container ? b.isWrapped(i.container) || b.isNode(i.container) ? (i.container = i.container[0] || i.container,
                    v = i.container["scroll" + x],
                    M = v + f(t).position()[x.toLowerCase()] + I) : i.container = null : (v = P.State.scrollAnchor[P.State["scrollProperty" + x]],
                      m = P.State.scrollAnchor[P.State["scrollProperty" + ("Left" === x ? "Top" : "Left")]],
                      M = f(t).offset()[x.toLowerCase()] + I),
                    l = {
                      scroll: {
                        rootPropertyValue: !1,
                        startValue: v,
                  ...
                  var N = function (a, o) {
                    var r, u = S.Hooks.getRoot(a), d = !1, v = o[0], m = o[1], g = o[2];
                    ...
                    (i.display !== s && null !== i.display && "none" !== i.display || i.visibility !== s && "hidden" !== i.visibility) && /opacity|filter/.test(a) && !g && 0 !== v && (g = 0),
                      i._cacheValues && h && h[a] ? (g === s && (g = h[a].endValue + h[a].unitType),
                        d = p.rootPropertyValueCache[u]) : S.Hooks.registered[a] ? g === s ? (d = S.getPropertyValue(t, u),
                          g = S.getPropertyValue(t, a, d)) : d = S.Hooks.templates[u][1] : g === s && (g = S.getPropertyValue(t, a));
                    var w, y, k, M = !1, x = function (t, e) {
                      var n, s;
                      return s = (e || "0").toString().toLowerCase().replace(/[%A-z]+$/, function (t) {
                        return n = t,
                          ""
                      }),
                        n || (n = S.Values.getUnitType(t)),
                        [s, n]
                    };
                    if (g !== v && b.isString(g) && b.isString(v)) {
                      ...
                      var j = 0
                        ...
                        , E = 0
                        , O = 0;
                      for (g = S.Hooks.fixColors(g),
                        v = S.Hooks.fixColors(v); j < g.length && I < v.length;) {
                        var N = g[j]
                          , V = v[I];
                        if (/[\d\.-]/.test(N) && /[\d\.-]/.test(V)) {
                          ...
                          r += N,
                            ...
                            0 === E && "r" === N || 1 === E && "g" === N || 2 === E && "b" === N || 3 === E && "a" === N || E >= 3 && "(" === N ? (3 === E && "a" === N && (O = 1),
                              E++) : O && "," === N ? ++O > 3 && (E = O = 0) : (O && E < (O ? 5 : 4) || E >= (O ? 4 : 3) && ")" === N && --E < (O ? 5 : 4)) && (E = O = 0)
                        }
                      }
                      j === g.length && I === v.length || (P.debug && console.error('Trying to pattern match mis-matched strings ["' + v + '", "' + g + '"]'),
                        r = s),
                        r && (L.length ? (P.debug && console.log('Pattern found "' + r + '" -> ', L, T, "[" + g + "," + v + "]"),
                          g = L,
                          v = T,
                          y = k = "") : r = s)
                    }
                    if (r || (w = x(a, g),
                      ...
                      g = parseFloat(g) || 0,
                      v = parseFloat(v) || 0,
                      "%" === y && (/^(fontSize|lineHeight)$/.test(a) ? (v /= 100,
                        y = "em") : /^scale/.test(a) ? (v /= 100,
                          y = "") : /(Red|Green|Blue)$/i.test(a) && (v = v / 100 * 255,
                            y = ""))),
                      /[\/*]/.test(M))
                      y = k;
                    else if (k !== y && 0 !== g)
                      if (0 === v)
                        ...
                        c = c || function () {
                          ...
                          return null === D.remToPx && (D.remToPx = parseFloat(S.getPropertyValue(n.body, "fontSize")) || 16),
                            null === D.vwToPx && (D.vwToPx = parseFloat(e.innerWidth) / 100,
                              D.vhToPx = parseFloat(e.innerHeight) / 100),
                            r.remToPx = D.remToPx,
                            r.vwToPx = D.vwToPx,
                            r.vhToPx = D.vhToPx,
                            P.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(r), t),
                            r
                        }();
                  ...
                  for (var V in w)
                    if (w.hasOwnProperty(V)) {
                      var F = S.Names.camelCase(V)
                        , $ = function (e, n) {
                          var s, o, r;
                          return b.isFunction(e) && (e = e.call(t, a, L)),
                            b.isArray(e) ? (s = e[0],
                              !b.isArray(e[1]) && /^[\d-]/.test(e[1]) || b.isFunction(e[1]) || S.RegEx.isHex.test(e[1]) ? r = e[1] : b.isString(e[1]) && !S.RegEx.isHex.test(e[1]) && P.Easings[e[1]] || b.isArray(e[1]) ? (o = n ? e[1] : u(e[1], i.duration),
                                r = e[2]) : r = e[1] || e[2]) : s = e,
                            n || (o = o || i.easing),
                            b.isFunction(s) && (s = s.call(t, a, L)),
                            b.isFunction(r) && (r = r.call(t, a, L)),
                            [s || 0, o, r]
                        }(w[V]);
                ...
                l.element && (S.Values.addClass(t, "velocity-animating"),
                  H.push(l),
                  p = r(t),
                  p && ("" === i.queue && (p.tweensContainer = l,
                    p.opts = i),
                    p.isAnimating = !0),
                  T === L - 1 ? (P.State.calls.push([H, g, i, null, j.resolver, null, 0]),
                    !1 === P.State.isTicking && (P.State.isTicking = !0,
                      d())) : T++)
              }
              var c, i = f.extend({}, P.defaults, k), l = {};
              switch (r(t) === s && P.init(t),
              parseFloat(i.delay) && !1 !== i.queue && f.queue(t, i.queue, function (e, n) {
                if (!0 === n)
                  return !0;
              ...
              if (!1 !== P.mock && (!0 === P.mock ? i.duration = i.delay = 1 : (i.duration *= parseFloat(P.mock) || 1,
                i.delay *= parseFloat(P.mock) || 1)),
                i.easing = u(i.easing, i.duration),
                i.begin && !b.isFunction(i.begin) && (i.begin = null),
                i.progress && !b.isFunction(i.progress) && (i.progress = null),
                i.complete && !b.isFunction(i.complete) && (i.complete = null),
                i.display !== s && null !== i.display && (i.display = i.display.toString().toLowerCase(),
                  "auto" === i.display && (i.display = P.CSS.Values.getDisplayType(t))),
                i.visibility !== s && null !== i.visibility && (i.visibility = i.visibility.toString().toLowerCase()),
                i.mobileHA = i.mobileHA && P.State.isMobile && !P.State.isGingerbread,
                !1 === i.queue)
                if (i.delay) {
                ...
                f.queue(t, i.queue, function (t, e) {
                  return !0 === e ? (j.promise && j.resolver(g),
                    !0) : (P.velocityQueueEntryFlag = !0,
                      void o(t))
                });
              "" !== i.queue && "fx" !== i.queue || "inprogress" === f.queue(t)[0] || f.dequeue(t)
            }
            var l, p, v, m, g, w, k, x = arguments[0] && (arguments[0].p || f.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || b.isString(arguments[0].properties));
            b.isWrapped(this) ? (p = !1,
              m = 0,
              g = this,
              v = this) : (p = !0,
                m = 1,
            ...
            if (p && P.Promise && (j.promise = new P.Promise(function (t, e) {
              ...
              x ? (w = arguments[0].properties || arguments[0].p,
                k = arguments[0].options || arguments[0].o) : (w = arguments[m],
                  k = arguments[m + 1]),
              !(g = o(g)))
              ...
              default:
                if (!f.isPlainObject(w) || b.isEmptyObject(w)) {
                  if (b.isString(w) && P.Redirects[w]) {
                    ...
                    var F = l.duration
                      , $ = l.delay || 0;
                    return !0 === l.backwards && (g = f.extend(!0, [], g).reverse()),
                      f.each(g, function (t, e) {
                        parseFloat(l.stagger) ? l.delay = $ + parseFloat(l.stagger) * t : b.isFunction(l.stagger) && (l.delay = $ + l.stagger.call(e, t, L)),
                          l.drag && (l.duration = parseFloat(F) || (/^(callout|transition)/.test(w) ? 1e3 : M),
                            l.duration = Math.max(l.duration * (l.backwards ? 1 - t / L : (t + 1) / L), .75 * l.duration, 200)),
                  ...
                  return j.promise ? j.rejecter(new Error(A)) : e.console && console.log(A),
                    t()
                }
                O = "start"
            }
            ...
            if (l.loop)
              for (var W = 0; W < R; W++) {
                ...
                W === R - 1 && (z.display = l.display,
                  z.visibility = l.visibility,
                  z.complete = l.complete),
                  I(g, "reverse", z)
              }
            return t()
          };
          ...
          return a.Redirects[t] = function (s, r, c, i, l, p, u) {
            ...
            for (f = 0; f < e.calls.length; f++) {
              var m = e.calls[f]
                ...
                , b = m[2] || {}
                , k = {};
              if (void 0 !== r.duration ? w = r.duration : void 0 !== e.defaultDuration && (w = e.defaultDuration),
                k.duration = w * ("number" == typeof y ? y : v),
                k.queue = r.queue || "",
                k.easing = b.easing || "ease",
                k.delay = parseFloat(b.delay) || 0,
                k.loop = !e.loop && b.loop,
                k._cacheValues = b._cacheValues || !0,
                0 === f) {
                if (k.delay += parseFloat(r.delay) || 0,
                  0 === c && (k.begin = function () {
              ...
              if (f === e.calls.length - 1) {
                ...
                k.complete = function () {
                  if (u && a.Redirects[t](s, r, c, i, l, p, !0 === u || Math.max(0, u - 1)),
                    e.reset) {
   ...
   */
      function a(t, e) {
        ...
        if (e = e || {},
          ...
          r && (t.addEventListener("mouseover", this.onMouse, !0),
            ...
            "function" == typeof t.onclick && (s = t.onclick,
      ...
      a.prototype.needsClick = function (t) {
        ...
        a.prototype.onTouchEnd = function (t) {
          var e, n, s, a, o, p = this.targetElement;
          ...
          if (this.cancelNextClick = !1,
            ...
            l && (o = t.changedTouches[0],
              p = document.elementFromPoint(o.pageX - window.pageXOffset, o.pageY - window.pageYOffset) || p,
              p.fastClickScrollParent = this.targetElement.fastClickScrollParent),
            ...
            return t.timeStamp - n > 100 || c && window.top !== window && "input" === s ? (this.targetElement = null,
              !1) : (this.focus(p),
                this.sendClick(p, t),
                c && "select" === s || (this.targetElement = null,
                  t.preventDefault()),
                !1);
          return !(!c || i || (a = p.fastClickScrollParent,
            !a || a.fastClickLastScrollTop === a.scrollTop)) || (this.needsClick(p) || (t.preventDefault(),
              this.sendClick(p, t)),
              !1)
        }
        ,
        ...
        a.prototype.destroy = function () {
          var t = this.layer;
          r && (t.removeEventListener("mouseover", this.onMouse, !0),
        ...
        a.notNeeded = function (t) {
          ...
          if (p && (s = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/),
          ...
          return "none" === t.style.msTouchAction || "manipulation" === t.style.touchAction || (a = +(/Firefox\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1],
            !!(a >= 27 && (e = document.querySelector("meta[name=viewport]"),
    ...
    (function (e) {
      ...
      t.exports = {
        ...
        getTransitionDuration: function (t, n) {
          var s, a = window.getComputedStyle(t, null), o = a.getPropertyValue("-webkit-transition-property") || a.getPropertyValue("transition-property"), r = a.getPropertyValue("-webkit-transition-duration") || a.getPropertyValue("transition-duration");
          if (!r || "none" == r)
            return 0;
          var c = o.split(",")
            , i = r.split(",");
        ...
        animateRolling: function (t) {
          function n() {
            ...
            var n = function (n) {
              n && !e(n.target).is(t.$item) || n && "clip" != n.originalEvent.propertyName.toLowerCase() || (t.$item.attr("data-rolling-animating", "0"),
                t.withOpacity && t.$item.css({
                  opacity: ""
                }),
                t.$item.css({
                ...
                t.$item.off("transitionend.clip-transition"),
                t.cb && t.cb())
            };
          ...
          var s, a, o, r = t.$item.outerWidth(), c = t.$item.outerHeight(), i = "rect(0px, " + r + "px, " + c + "px, 0px)";
          "in" == t.tp && ("toright" == t.direction && (s = "rect(0px, 0px, " + c + "px, 0px)"),
            "toleft" == t.direction && (s = "rect(0px, " + r + "px, " + c + "px, " + r + "px)"),
            "tobottom" == t.direction && (s = "rect(0px, " + r + "px, 0px, 0px)"),
            "totop" == t.direction && (s = "rect(" + c + "px, " + r + "px, " + c + "px, 0px)")),
            "out" == t.tp && ("toleft" == t.direction && (s = "rect(0px, 0px, " + c + "px, 0px)"),
              "toright" == t.direction && (s = "rect(0px, " + r + "px, " + c + "px, " + r + "px)"),
              "totop" == t.direction && (s = "rect(0px, " + r + "px, 0px, 0px)"),
              "tobottom" == t.direction && (s = "rect(" + c + "px, " + r + "px, " + c + "px, 0px)")),
            t.fromRect && (s = t.fromRect),
            "in" == t.tp && (a = s,
              o = i),
            "out" == t.tp && (a = i,
              o = s),
            "1" == t.$item.attr("data-rolling-animating") ? (t.$item.off("transitionend.clip-transition"),
              clearTimeout(t.$item.attr("rolling-show-timeout"))) : (t.withOpacity && t.$item.css({
                opacity: "in" == t.tp ? 0 : 1
              }),
                t.$item.css({
                  clip: a,
    ...
    (function (e) {
      ...
      t.exports = s.Router.extend({
        ...
        loadShantelleImage: function () {
          ...
          if (app.els.$shantelle = e(".ShantelleImage"),
            !app.settings.isMobile) {
            var n = new Image
              , s = new Image
              , a = 0;
            n.onload = t,
              n.src = app.settings.isDesktop ? "/static/img/index/shantelle.jpg" : "/static/img/index/shantelle_small.jpg",
              s.onload = t,
              s.src = app.settings.isDesktop ? "/static/img/index/mask24.png" : "/static/img/index/mask24_small.png";
        ...
        activate: function (t, e) {
          return e = e || {},
            app.views.footer.setActive(e.footerLink || ""),
            app.state.view ? (e.fastNavigate = window.app.fastNavigate,
              window.app.fastNavigate = !1,
              e.zoomNavigate = window.app.zoomNavigate,
              window.app.zoomNavigate = !1,
              app.state.prevView = app.state.view,
              void (this.isSectionLogic(app.state.prevView, t, e) ? this.activateSectionLogic(e) : this.activateStandardLogic(t, e))) : (e.server = !0,
                e.inAnimated = !1,
                app.state.view = new t(e),
                app.els.$shantelle.attr("data-state", app.state.view.SHANTELLE_PARAMS ? app.state.view.SHANTELLE_PARAMS.state : "none"),
                void app.state.view.activate())
        },
          ...
          return Promise.all([app.state.view.playOut({
            ...
            app.state.isServer = !1,
              ...
              app.state.view.activate(s).then(function () {
                ...
                return app.els.$shantelle.removeAttr("style").attr("data-state", o.SHANTELLE_PARAMS ? o.SHANTELLE_PARAMS.state : "none").css("opacity", t),
                  app.state.view.playIn({
                    duration: r,
                    zoom: n.zoomNavigate,
                    view: o
                  })
      ...
      t.exports = s.extend({
        ...
        activate: function (t) {
          return this.setTitle(),
            s.prototype.activate.call(this, t)
        }
      })
    }
    ).call(e, n(4))
  ...
  , function (t, e, n) {
    (function (e) {
      ...
      t.exports = s.View.extend(a.extend({}, s.Events, {
        ...
        loadData: function () {
          return this.data ? o.createEmptyPromise() : this.disableCache ? this.forceLoadData(this.apiUrl) : void 0 !== window.app.cache[this.apiUrl] ? (this.data = window.app.cache[this.apiUrl],
            o.createEmptyPromise()) : this.forceLoadData(this.apiUrl).then(function () {
  ...
  , 17, function (t, e, n) {
    ...
    var o = (n(31)(s),
      a.webpackDependencies || (a.webpackDependencies = {}));
    ...
    !function (e, n) {
      ...
      return function (t) {
        function e(s) {
          ...
          return t[s].call(a.exports, a, a.exports, e),
            a.loaded = !0,
            a.exports
        }
        var n = {};
        ...
        t.exports.configure = function (t, e) {
          ...
          return r.FileSystemLoader ? n = new r.FileSystemLoader(t, {
            ...
            i = new a.Environment(n, e),
            e && e.express && i.express(e.express),
            i
        }
          ,
          t.exports.compile = function (e, n, s, a) {
            return i || t.exports.configure(),
              new t.exports.Template(e, n, s, a)
          }
          ,
          ...
          t.exports.renderString = function (e, n, s) {
            return i || t.exports.configure(),
              i.renderString(e, n, s)
          }
          ,
          c && (t.exports.precompile = c.precompile,
            t.exports.precompileString = c.precompileString)
      }
        , function (t, e) {
          "use strict";
          ...
          e.prettifyError = function (t, n, s) {
            if (s.Update || (s = new e.TemplateError(s)),
              s.Update(t),
              !n) {
              var a = s;
            ...
            e.TemplateError = function (t, e, n) {
              ...
              return s.name = "Template render error",
                s.message = t,
                s.lineno = e,
                s.colno = n,
                s.firstUpdate = !0,
            ...
            e.map = function (t, e) {
              ...
              for (var a = 0; a < t.length; a++)
                s[s.length] = e(t[a], a);
              return t.length === +t.length && (s.length = t.length),
                s
            }
            ,
        ...
        , function (t, e, n) {
          ...
          var a, o = n(3), r = n(4), c = n(1), i = n(6), l = n(3), p = n(7), u = n(3), d = n(8), h = n(9), f = d.Frame;
          ...
          var v = i.extend({
            ...
            removeExtension: function (t) {
              ...
              e && (this.extensionsList = c.without(this.extensionsList, e),
            ...
            addFilter: function (t, e, n) {
              var s = e;
              return n && this.asyncFilters.push(t),
                this.filters[t] = s,
                this
            },
            ...
            getTemplate: function (t, e, n, s, o) {
              ...
              if (!i) {
                var u, d = this, h = function (n, r) {
                  if (r || n || s || (n = new Error("template not found: " + t)),
                    n) {
                    if (!o)
                      throw n;
                    o(n)
                    ...
                    var c;
                    r ? (c = new a(r.src, d, r.path, e),
                      r.noCache || (r.loader.cache[t] = c)) : c = new a("", d, "", e),
                      o ? o(null, c) : u = c
                  }
                };
          ...
          a = i.extend({
            ...
            render: function (t, e, n) {
              ...
              return o.rootRenderFunc(o.env, i, l || new f, d, function (t, e) {
                if (t && (t = c.prettifyError(o.path, o.env.opts.dev, t)),
                  n)
                  a ? s(n, t, e) : n(t, e);
                else {
                  if (t)
          ...
          t.exports = a,
            o.prototype.call = function () {
              try {
                ...
                a.onerror ? a.onerror(t) : (i.push(t),
                  l())
              } finally {
                this.task = null,
                  c[c.length] = this
        ...
        , function (t, e) {
          (function (e) {
            ...
            t.exports = n;
            var r, c = [], i = !1, l = 0, p = 1024, u = e.MutationObserver || e.WebKitMutationObserver;
            ...
            , r = {
              ...
              dictsort: function (t, e, n) {
                ...
                return s.sort(function (t, n) {
                  var s = t[r]
                    , o = n[r];
                  return e || (a.isString(s) && (s = s.toUpperCase()),
                    a.isString(o) && (o = o.toUpperCase())),
                    s > o ? 1 : s === o ? 0 : -1
                }),
                  s
              },
              ...
              escape: function (t) {
                return t instanceof o.SafeString ? t : (t = null === t || void 0 === t ? "" : t,
                  o.markSafe(a.escape(t.toString())))
              },
              safe: function (t) {
                return t instanceof o.SafeString ? t : (t = null === t || void 0 === t ? "" : t,
                  o.markSafe(t.toString()))
              },
              first: function (t) {
                return t[0]
              },
              ...
              replace: function (t, e, n, s) {
                ...
                if ("number" == typeof t && (t += ""),
                  "string" != typeof t && !(t instanceof o.SafeString))
                  return t;
                if ("" === e)
                  return r = n + t.split("").join(n) + n,
                    o.copySafeness(t, r);
                var c = t.indexOf(e);
                if (0 === s || c === -1)
                  return t;
                for (var i = 0, l = 0; c > -1 && (s === -1 || l < s);)
                  r += t.substring(i, c) + n,
                    ...
                    l++,
                    c = t.indexOf(e, i);
                return i < t.length && (r += t.substring(i)),
                  o.copySafeness(a, r)
              },
              reverse: function (t) {
                var e;
                return e = a.isString(t) ? r.list(t) : a.map(t, function (t) {
                  ...
                  e.reverse(),
                  a.isString(t) ? o.copySafeness(t, e.join("")) : e
              },
              round: function (t, e, n) {
                e = e || 0;
                var s, a = Math.pow(10, e);
                return s = "ceil" === n ? Math.ceil : "floor" === n ? Math.floor : Math.round,
                  s(t * a) / a
              },
                ...
                return t = a.map(t, function (t) {
                  ...
                  t.sort(function (t, o) {
                    ...
                    return s ? (r = t[s],
                      c = o[s]) : (r = t,
                        c = o),
                      !n && a.isString(r) && a.isString(c) && (r = r.toLowerCase(),
                        c = c.toLowerCase()),
                      r < c ? e ? 1 : -1 : r > c ? e ? -1 : 1 : 0
                  }),
                  t
              }),
              string: function (t) {
        ...
        , function (t, e, n) {
          ...
          function s(t, e, n) {
            return function () {
              var s, a, c = r(arguments), i = o(arguments);
              if (c > t.length) {
                ...
                for (s = Array.prototype.slice.call(arguments, 0, c),
                  a = c; a < t.length; a++) {
                  var p = t[a];
                  s.push(i[p]),
                    delete i[p]
          ...
          function c(t) {
            return "string" != typeof t ? t : (this.val = t,
              void (this.length = t.length))
          }
          function i(t, e) {
          ...
          function p(t, e) {
            return t = void 0 !== t && null !== t ? t : "",
              !e || t instanceof c || (t = w.escape(t.toString())),
              t
          }
          function u(t, e, n) {
            if (null === t || void 0 === t)
          ...
          function n() {
            ...
            o.iteritems = o.items,
              ...
              t.memberLookup = function (t, n, r) {
                return t = t || {},
                  e.isArray(t) && a.hasOwnProperty(n) ? function () {
  ...
  , function (t, e, n) {
    ...
    t.exports = s.extend({
      ...
      activate: function (t) {
        return console.log("activate dummy"),
          this.parent.setTitle(),
          s.prototype.activate.call(this, t)
      },
      destroy: function () {
        return console.log("destroy dummy"),
          s.prototype.destroy.call(this)
      },
      deactivate: function (t) {
        return console.log("deactivate dummy"),
          s.prototype.deactivate.call(this, t)
      }
    })
  }
  , function (t, e, n) {
  ...
  , function (t, e, n) {
    ...
    n(50),
      t.exports = s.extend({
        ...
        activate: function () {
          return console.log("activate index"),
            s.prototype.activate.call(this)
        },
        viewsRegistration: function () {
        ...
        destroy: function () {
          return console.log("destroy index"),
            s.prototype.destroy.call(this)
        },
        deactivate: function (t) {
          return console.log("deactivate index"),
            s.prototype.deactivate.call(this, t)
        }
      })
  }
      ...
      t.exports = s.extend({
              ...
              c % 4 == 0 && o.each(r, function (t, e) {
                for (var n = [], s = 0; s < t.parts.length; s++) {
                  for (var a = t.parts[s], o = [], r = 0; r < a.data.length >> 1; r++) {
                    var c = a.data[r << 1]
                      , i = a.data[(r << 1) + 1];
                    r == (a.data.length >> 1) - 1 && (c += 3 * Math.random() - 1.5,
                      i += 3 * Math.random() - 1.5),
                      o[o.length] = c,
                      o[o.length] = i
                  }
        ...
        updateSVG: function () {
          if (!app.settings.isMobile) {
            if (app.settings.isTablet ? (this.effectMultiplier += .05 * this.effectMultiplierDir,
              this.effectMultiplier = Math.min(Math.max(this.effectMultiplier, 0), 1)) : this.effectMultiplier = 1,
              this.effectMultiplier > 0) {
              ...
              o.each(this.paths, function (t, o) {
                if (!(t.x1 > n + e || t.x2 < n - e || t.y1 > s + e || t.y2 < s - e) || t.changed) {
                  ...
                  if (l) {
                    ...
                    1 == a.controls.tp && (c = w * m[0],
                      i = y * m[1]),
                      2 == a.controls.tp && (c = w,
                        i = y),
                      3 == a.controls.tp && (c = w + (n - p) * (e - d) / e,
                        i = y + (s - u) * (e - d) / e),
                      isNaN(c) && console.log(t)
                  }
                  (l || t.changed) && (t.node.setAttribute("transform", l ? "translate(" + c + ", " + i + ")" : ""),
                    t.changed = l)
                }
              })
            }
        ...
        onMouseMove: function (t) {
          app.settings.isDesktop && (this.relX = t.pageX,
            this.relY = t.pageY)
        },
        onTouchStart: function (t) {
          if (app.settings.isTablet) {
            ...
            this.relX = e.pageX,
              this.relY = e.pageY,
              0 == this.effectMultiplier && (this.effectMultiplier = .01,
                this.effectMultiplierDir = 1)
          }
        },
        ...
        destroy: function () {
          return console.log("destroy indexIntro"),
            cancelAnimationFrame(this.animationFrame),
            s.prototype.destroy.call(this)
        },
        deactivate: function (t) {
          return console.log("deactivate indexIntro"),
            s.prototype.deactivate.call(this, t)
        }
      })
    }
          ...
          try {
            ...
            t.getTemplate("front/utils/macros.jinja", !1, "assets/app/front/components/IndexIntro/IndexIntro.jinja", !1, function (l, p) {
              return l ? void a(l) : void p.getExported(function (l, p) {
                return l ? void a(l) : (e.setVariable("macros", p),
                  ...
                  void t.getTemplate("front/pages/Index/bg.svg", !1, "assets/app/front/components/IndexIntro/IndexIntro.jinja", null, function (l, p) {
                    return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                      return l ? void a(l) : (c += p,
                        c += '\n\t\t</div>\n        <div class="mobile-image-wrapper"></div>\n\t\t<div class="menu-link">',
                        void t.getTemplate("front/pages/Index/main.svg", !1, "assets/app/front/components/IndexIntro/IndexIntro.jinja", null, function (l, p) {
                          return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                            return l ? void a(l) : (c += p,
                              c += '<div class="l-1"></div><div class="l-2"></div><div class="l-3"></div><div class="l-4"></div></div>\n    \t<a href="',
                              c += s.suppressValue((o = 9,
                                r = 18,
                                s.callWrap(s.contextOrFrameLookup(e, n, "url"), "url", e, ["sm:news"])), t.opts.autoescape),
                              c += '" class="u-Route news-link shake zoom-navigate">',
                              void t.getTemplate("front/pages/Index/news.svg", !1, "assets/app/front/components/IndexIntro/IndexIntro.jinja", null, function (l, p) {
                                return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                  return l ? void a(l) : (c += p,
                                    c += '</a>\n    \t<a href="',
                                    c += s.suppressValue((o = 10,
                                      r = 18,
                                      s.callWrap(s.contextOrFrameLookup(e, n, "url"), "url", e, ["sm:projects"])), t.opts.autoescape),
                                    c += '" class="u-Route work-link shake zoom-navigate">',
                                    void t.getTemplate("front/pages/Index/work.svg", !1, "assets/app/front/components/IndexIntro/IndexIntro.jinja", null, function (l, p) {
                                      return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                        return l ? void a(l) : (c += p,
                                          c += '</a>\n    \t<a href="',
                                          c += s.suppressValue((o = 11,
                                            r = 18,
                                            s.callWrap(s.contextOrFrameLookup(e, n, "url"), "url", e, ["sm:info"])), t.opts.autoescape),
                                          c += '" class="u-Route info-link shake zoom-navigate">',
                                          void t.getTemplate("front/pages/Index/info.svg", !1, "assets/app/front/components/IndexIntro/IndexIntro.jinja", null, function (o, r) {
                                            return o ? void a(o) : void r.render(e.getVariables(), n, function (o, r) {
                                              return o ? void a(o) : (c += r,
                                                ...
                                                c += '" class="shop-link shake">',
                                                void t.getTemplate("front/pages/Index/shop.svg", !1, "assets/app/front/components/IndexIntro/IndexIntro.jinja", null, function (o, r) {
                                                  return o ? void a(o) : void r.render(e.getVariables(), n, function (o, r) {
                                                    return o ? void a(o) : (c += r,
                                                      c += '</a>\n        <div class="play-link shake">',
                                                      void t.getTemplate("front/pages/Index/play.svg", !1, "assets/app/front/components/IndexIntro/IndexIntro.jinja", null, function (o, r) {
                                                        return o ? void a(o) : void r.render(e.getVariables(), n, function (o, r) {
                                                          return o ? void a(o) : (c += r,
          ...
          try {
            var i = null
              , l = s.makeMacro(["id"], ["bound", "title"], function (a, c) {
                ...
                var i = "";
                return i += "<svg",
                  s.contextOrFrameLookup(e, n, "bound") && (i += ' viewBox="',
                    i += s.suppressValue(s.contextOrFrameLookup(e, n, "bound"), t.opts.autoescape),
                    i += '"'),
                  i += ">\n        ",
                  s.contextOrFrameLookup(e, n, "title") && (i += "<title>",
                    i += s.suppressValue(s.contextOrFrameLookup(e, n, "title"), t.opts.autoescape),
                    i += "</title>"),
                  i += '\n        <use xlink:href="#',
                  i += s.suppressValue(a, t.opts.autoescape),
                  i += '"></use>\n    </svg>',
                  i += s.suppressValue((o = 4,
                    r = 17,
                    s.callWrap(s.contextOrFrameLookup(e, n, "caller"), "caller", e, [])), t.opts.autoescape),
                  n = n.pop(),
                  new s.SafeString(i)
              });
            ...
            var p = s.makeMacro(["component"], ["mods", "classes", "data"], function (c, i) {
              ...
              return t.getTemplate(c, !1, "assets/app/front/utils/macros.jinja", null, function (c, i) {
                return c ? void a(c) : void i.render(e.getVariables(), n, function (c, i) {
                  return c ? void a(c) : (l += i,
                    void (l += s.suppressValue((o = 11,
                      r = 30,
                      s.callWrap(s.contextOrFrameLookup(e, n, "caller"), "caller", e, [])), t.opts.autoescape)))
                })
              }),
    ...
    !function (r) {
      ...
      return l.prototype.init = function () {
        ...
        l.prototype.update = function (t, e) {
          t = t || !1,
            t && (this.min = c(this.$element[0].getAttribute("min"), 0),
        ...
        l.prototype.handleDown = function (t) {
          if (t.preventDefault(),
            !(t.button && 0 !== t.button || (this.$document.on(this.moveEvent, this.handleMove),
      ...
      t.exports = a.extend({
        ...
        render: function () {
          return a.prototype.render.call(this),
            this.options.inAnimated && this.$el.css({
              opacity: 0
            }),
            this
        },
        ...
        activate: function () {
          return console.log("activate InfoSection"),
            e(window).on("scroll", this.handleParalax),
            app.views.topNav.changeColor("black"),
            this.$(".InfoSectionCredits a").attr("target", "_blank"),
            a.prototype.activate.call(this)
        },
        deactivate: function (t) {
          return console.log("deactivate InfoSection"),
            e(window).off("scroll", this.handleParalax),
            a.prototype.deactivate.call(this, t)
        },
        playIn: function (t) {
          this.handleParalax();
          var e = this;
        ...
        playOut: function (t) {
          this.playInTimeout && (clearTimeout(this.playInTimeout),
            this.playInResolve && this.playInResolve(),
            delete this.playInTimeout,
            delete this.playInResolve);
          var e = this;
          return new Promise(function (n) {
            app.els.$shantelle.animate({
              opacity: 0
        ...
        destroy: function () {
          return console.log("destroy InfoSection"),
              ...
              c += "\n",
                t.getTemplate("front/utils/macros.jinja", !1, "assets/app/front/pages/Info/InfoSection.jinja", !1, function (o, r) {
                  return o ? void a(o) : void r.getExported(function (o, r) {
                    return o ? void a(o) : (e.setVariable("macros", r),
                      c += "\n\n",
        ...
        function s(t, e, n, s, a) {
          ...
          try {
            c += '\n    <div class="Section InfoSection">\n\n    ',
              s.contextOrFrameLookup(e, n, "CRAWLER") || (c += '\n        <div class="Section-main">\n            <div class="InfoSectionWrapper">\n                <div class="InfoSectionHeader">\n                    <h1><span class="dummy">Info</span><span class="animate">Info</span></h1>\n\n                    <div class="space"></div>\n                    <div><a class="InfoBtn InfoBtn--black visible" href="mailto:',
                c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "email"), t.opts.autoescape),
                c += '">Contact</a></div>\n                    ',
                s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "pressKit") && (c += '\n                        <div><a class="InfoBtn visible" href="',
                  c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "pressKit"), t.opts.autoescape),
                  c += '" target="_blank">Press Kit</a></div>\n                    '),
                c += "\n                </div>\n                ",
                o = 22,
                r = 32,
                s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) || (c += '<div class="InfoSectionSep visible"></div>'),
                c += '\n                <div class="InfoSectionText visible clearfix">\n                    <div class="InfoSectionTextLeft">',
                c += s.suppressValue(t.getFilter("safe").call(e, s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "text")), t.opts.autoescape),
                c += '</div>\n                    <div class="InfoSectionTextRight">',
                c += s.suppressValue(t.getFilter("safe").call(e, s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "text2")), t.opts.autoescape),
                c += "</div>\n                </div>\n\n                ",
        ...
        function o(t, e, n, s, a) {
          ...
          try {
            e.getSuper(t, "data", o, n, s, function (o, r) {
              return o ? void a(o) : (r = s.markSafe(r),
                i += "\n    ",
                i += s.suppressValue(r, t.opts.autoescape),
                i += "\n    window.app.data.infoProjects = ",
                i += s.suppressValue(t.getFilter("safe").call(e, t.getFilter("jsonify").call(e, s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "projects"))), t.opts.autoescape),
                i += ";\n",
                void a(null, i))
            })
          } catch (t) {
        ...
        function t(t, e, n, s, a) {
          ...
          try {
            ...
            c += '<div class="InfoOriginalArt">\n    <div class="InfoSectionSep visible"></div>\n    <div class="InfoOriginalArtTitle">ORIGINAL ART</div>\n\n    ',
              o = 4,
              r = 16,
              s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) ? (c += '<img class="InfoOriginalArtImg" src="',
                c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "orginalArtImage_mobile"), t.opts.autoescape),
                c += '">') : (c += '<div class="InfoOriginalArtImg" style="background-image: url(',
                  c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "orginalArtImage_main2x"), t.opts.autoescape),
                  c += ')"></div>'),
        ...
        function t(t, e, n, s, a) {
          ...
          try {
            ...
            c += '<div class="InfoMedia InfoSectionTabl">\n    ',
              ...
              s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "news") && (c += '\n            <a class="InfoMediaNewsLink clearfix u-Route" href="',
                c += s.suppressValue(s.memberLookup(s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "news"), "link"), t.opts.autoescape),
                c += '">\n                ',
                o = 5,
                r = 29,
                s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) && (c += '<span class="InfoMediaNewsImage" style="background-image: url(',
                  c += s.suppressValue(s.memberLookup(s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "news"), "previewImage"), t.opts.autoescape),
                  c += ')"></span>'),
                c += '\n\n                <span class="InfoMediaNewsText">\n                    <span class="InfoMediaNewsTitle">',
                c += s.suppressValue(s.memberLookup(s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "news"), "title"), t.opts.autoescape),
                c += '</span>\n                    <span class="InfoMediaNewsDate">',
                c += s.suppressValue(s.memberLookup(s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "news"), "month"), t.opts.autoescape),
                c += "<br>",
                c += s.suppressValue(s.memberLookup(s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "news"), "year"), t.opts.autoescape),
                c += "</span>\n                </span>\n\n                ",
                o = 12,
                r = 32,
                s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) || (c += '<span class="InfoMediaNewsImage" style="background-image: url(',
              ...
              n = n.push();
            var l = t.getFilter("batch").call(e, s.memberLookup(s.contextOrFrameLookup(e, n, "info"), "logos"), (o = 19,
              r = 56,
              s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) ? 2 : 3));
            if (l)
                ...
                if (h)
                  for (var f = h.length, v = 0; v < h.length; v++) {
                    ...
                    n.set("logo", m),
                      ...
                      o = 24,
                      r = 41,
                      s.callWrap(s.contextOrFrameLookup(e, n, "isDesktop"), "isDesktop", e, [s.contextOrFrameLookup(e, n, "request")]) && (c += '<span class="InfoMediaPartnerHover">',
                        c += s.suppressValue(t.getFilter("safe").call(e, s.memberLookup(m, "text")), t.opts.autoescape),
                        c += "</span>"),
                      c += "\n                        </a>\n                    "
                  }
                n = n.pop(),
                ...
                if (u)
                  for (var d = u.length, h = 0; h < u.length; h++) {
                    ...
                    n.set("project", f),
                      ...
                      c += '">\n                    <i>',
                      c += s.suppressValue((o = 18,
                        r = 45,
                        s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["pin", s.makeKeywordArgs({
                          caller: function () {
                      ...
                      c += "</span>\n\n                    ",
                      s.memberLookup(f, "city") && s.memberLookup(f, "country") ? (c += '\n                        <span class="InfoPublicWorksProjectAddr">',
                        c += s.suppressValue(s.memberLookup(f, "city"), t.opts.autoescape),
                        c += ", ",
                        c += s.suppressValue(s.memberLookup(f, "country"), t.opts.autoescape),
                        c += "</span>\n                    ") : !s.memberLookup(f, "city") && s.memberLookup(f, "country") ? (c += '\n                        <span class="InfoPublicWorksProjectAddr">',
                          c += s.suppressValue(s.memberLookup(f, "country"), t.opts.autoescape),
                          c += "</span>\n                    ") : s.memberLookup(f, "city") && !s.memberLookup(f, "country") ? (c += '\n                        <span class="InfoPublicWorksProjectAddr">',
                            c += s.suppressValue(s.memberLookup(f, "city"), t.opts.autoescape),
  ...
  , 17, function (t, e, n) {
    (function (e) {
      ...
      t.exports = a.extend({
        ...
        activate: function () {
          var t = this;
          return e(window).on("scroll", this.handleScroll),
            this.options.server && this.handleScroll(),
            a.prototype.activate.call(this).then(function () {
              t.initMap()
            })
        },
        deactivate: function (t) {
          return e(window).off("scroll", this.handleScroll),
            a.prototype.deactivate.call(this, t)
        },
        recalcElementsPos: function () {
          app.settings.isMobile || (this.publicWorksPos = this.$(".InfoPublicWorksProjectsList").offset().top,
            this.publicWorksHeight = this.$(".InfoPublicWorksProjectsList").height(),
            this.publicWorksMapPos = this.$(".InfoPublicWorksMap").offset().top - parseInt(this.$(".InfoPublicWorksMap").attr("data-shift")) - 20,
            this.publicWorksMapHeight = this.$(".InfoPublicWorksMap").height())
        },
        handleScroll: function () {
          if (!app.settings.isMobile) {
            var t = e(window).scrollTop();
            if (this.recalcElementsPos.__throttled(),
              !app.settings.isMobile) {
              var n = 0;
              t > this.publicWorksMapPos && (n = t - this.publicWorksMapPos,
                this.publicWorksMapPos + this.publicWorksMapHeight + n + 40 > this.publicWorksPos + this.publicWorksHeight && (n -= this.publicWorksMapPos + this.publicWorksMapHeight + n + 40 - (this.publicWorksPos + this.publicWorksHeight))),
                t > this.publicWorksMapPos - 150 ? (this.hideNavOnMap = !0,
                  app.views.topNav.hide()) : (this.hideNavOnMap && app.views.topNav.show(),
                    this.hideNavOnMap = !1),
        ...
        showProject: function (t) {
          app.settings.isMobile && (this.$(".InfoPublicWorksInfo").addClass("InfoPublicWorks--opened"),
          ...
          this.map.setCenter(e),
            ...
            this.marker = new google.maps.Marker({
              ...
              map: this.map,
              icon: {
                url: "/static/img/info/mappin.png",
        ...
        destroy: function () {
          return console.log("destroy InfoPublicWorks"),
            this.marker && this.marker.setMap(null),
            a.prototype.destroy.call(this)
        }
      })
        ...
        t.exports = o.extend({
          ...
          initialize: function (t) {
            o.prototype.initialize.call(this, t),
              ...
              t.server && (this.$el.hide(),
                this.fixScrollBars(),
                this.$el.addClass("NewsPopup--visible"),
                this.$el.addClass("NewsPopup--scroll"),
                this.$el.outerHeight(),
                this.$el.show(),
                e("html").addClass("HideGlobalScroll"),
                this.$(".NewsPopupContent").scrollTop(0),
                this.recalcOnScroll(),
          ...
          updateNextPanel: function () {
            this.$(".NewsItemNext:not(.proceeded)").each(function (t, n) {
              var s, o = e(n), r = o.closest(".NewsItem"), c = r.attr("data-url"), i = a.findWhere(this.data, {
                url: c
              }), l = a.findIndex(this.data, i), p = l == this.data.length - 1;
              o.toggle(!p).addClass("proceeded"),
                p || (s = this.data[l + 1].title,
                  e(".NewsItemNextTitle", o).text(s))
            }
              .bind(this))
          },
          ...
          recalcOnScroll: function () {
            if (this.data && !this.preventScrollHandle) {
              var t, n, o, r, c, i = [], l = (e(window).width(),
                e(window).height()), p = this.$(".NewsPopupContent"), u = p[0];
              p.scrollTop();
              if (this.$(".NewsItem").each(function (t, n) {
                ...
                for (var d = this.newsPos.length - 1; d >= 0; d--)
                  if (app.settings.isMobile && this.newsPos[d].top <= 30 && (n = a.findWhere(this.data, {
                    ...
                    this.$(".NewsPopupTitle").text(n.title),
                    this.$(".NewsPopupTitle").addClass("visible")),
                    this.newsPos[d].top < l / 2) {
                    t = this.newsPos[d].$el,
                ...
                this.currentNews = n,
                  ...
                  app.settings.isDesktop && !c && u.scrollHeight - u.scrollTop == u.clientHeight && (clearTimeout(this.addNewsTimeout),
                    this.addNewsTimeout = setTimeout(function () {
          ...
          activate: function (t) {
            return console.log("activate news"),
              o.prototype.activate.call(this, t).then(function () {
                this.$content = this.$(".NewsPopupContent"),
                  ...
                  this.recalcOnScroll(),
                  app.views.topNav.changeColor("black"),
                  this.options.inAnimated || this.options.server || (this.fixScrollBars(),
                    this.$el.addClass("NewsPopup--visible"),
                    this.$el.addClass("NewsPopup--scroll"),
                    e("html").addClass("HideGlobalScroll"),
                    this.$(".NewsPopupContent").focus())
          ...
          fixScrollBars: function () {
            app.settings.isMobile || (this.$(".NewsPopupSidebar").css("right", app.utils.getScrollbarWidth()),
              this.$(".NewsItem, .NewsPopupBG").css("width", "calc(100vw - " + (120 + app.utils.getScrollbarWidth()) + "px)"))
          },
          playIn: function (t) {
            console.log("playIn");
            var n = this;
            return this.fixScrollBars(),
              this.options.inAnimated ? new Promise(function (s) {
                n.$el.outerHeight(),
          ...
          viewsRegistration: function () { },
          destroy: function () {
            return console.log("destroy news"),
              o.prototype.destroy.call(this)
          },
          deactivate: function (t) {
            return console.log("deactivate news"),
              e("html").removeClass("HideGlobalScroll"),
              app.views.topNav.changeColor("white"),
              o.prototype.deactivate.call(this, t)
          }
        })
    }
    ).call(e, n(4))
                ...
                return l ? void a(l) : (e.setVariable("macros", p),
                  ...
                  void t.getTemplate("front/pages/News/News-inner.jinja", !1, "assets/app/front/pages/News/NewsPopup.jinja", null, function (l, u) {
                    return l ? void a(l) : void u.render(e.getVariables(), n, function (l, u) {
                      return l ? void a(l) : (c += u,
                        c += '\n    </div>\n\n\t<div class="NewsPopupSidebar white-theme">\n\t    <div class="NewsPopupClose">\n\t    \t<div class="l1"></div>\n\t    \t<div class="l2"></div>\n\t    </div>\n\n\t\t',
                        o = 14,
                        r = 14,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) && (c += '<div class="NewsPopupTitle"></div>'),
                        c += '\n\n\t\t<div class="NewsPopupShare">\n\t\t\t',
                        o = 17,
                        r = 19,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) || (c += "<span>Share</span>"),
                        c += "\n\t\t\t",
                        o = 18,
                        r = 15,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) && (c += '<div class="NewsPopupShareIcon">',
                          c += s.suppressValue((o = 18,
                            r = 79,
                            s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["share", s.makeKeywordArgs({
                              caller: function () {
                                var t = s.makeMacro([], [], function (t) {
                                  n = n.push(!0),
                                    t = t || {},
                          ...
                          c += "</div>"),
                        c += '\n\t\t\t<div class="NewsPopupShareDropdown">\n\t\t\t\t<div class="NewsPopupShareDropdownPinterest">',
                        c += s.suppressValue((o = 20,
                          r = 71,
                          s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["pinterest", s.makeKeywordArgs({
                            caller: function () {
                              var t = s.makeMacro([], [], function (t) {
                                n = n.push(!0),
                                  t = t || {},
                        ...
                        c += '</div>\n\t\t\t\t<div class="NewsPopupShareDropdownFacebook">',
                        c += s.suppressValue((o = 21,
                          r = 70,
                          s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["facebook", s.makeKeywordArgs({
                            caller: function () {
                              var t = s.makeMacro([], [], function (t) {
                                n = n.push(!0),
                                  t = t || {},
                        ...
                        c += '</div>\n\t\t\t\t<div class="NewsPopupShareDropdownTwitter">',
                        c += s.suppressValue((o = 22,
                          r = 69,
                          s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["twitter", s.makeKeywordArgs({
                            caller: function () {
                              var t = s.makeMacro([], [], function (t) {
                                n = n.push(!0),
                                  t = t || {},
                        ...
                        c += '</div>\n\t\t\t\t<div class="NewsPopupShareDropdownTumblr">',
                        c += s.suppressValue((o = 23,
                          r = 68,
                          s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["tumblr", s.makeKeywordArgs({
                            caller: function () {
                              var t = s.makeMacro([], [], function (t) {
                                n = n.push(!0),
                                  t = t || {},
                        ...
                        o = 26,
                        r = 19,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isDesktop"), "isDesktop", e, [s.contextOrFrameLookup(e, n, "request")]) || (c += '<div class="NewsPopupShareOverlay"></div>'),
                        c += "\n\n\t\t",
                        o = 28,
                        r = 18,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) || (c += '\n\t\t\t<a class="NewsPopupNext InnerNewsLink hidden">',
                          c += s.suppressValue((o = 29,
                            r = 71,
                            s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["next", s.makeKeywordArgs({
                              caller: function () {
                                var t = s.makeMacro([], [], function (t) {
                                  n = n.push(!0),
                                    t = t || {},
                          ...
                          c += '</a>\n\t\t\t<a class="NewsPopupPrev InnerNewsLink hidden">',
                          c += s.suppressValue((o = 30,
                            r = 71,
                            s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["prev", s.makeKeywordArgs({
                              caller: function () {
                                var t = s.makeMacro([], [], function (t) {
                                  n = n.push(!0),
                                    t = t || {},
                  ...
                  for (var d = u.length, h = 0; h < u.length; h++) {
                    ...
                    n.set("block", f),
                      ...
                      "Text" == s.memberLookup(f, "tp") ? (c += '\n                    <div class="NewsItemText">',
                        c += s.suppressValue(t.getFilter("safe").call(e, s.memberLookup(f, "text")), t.opts.autoescape),
                        c += "</div>\n                ") : "Img" == s.memberLookup(f, "tp") ? (c += '\n                    <div class="NewsItemImg">\n                        <div class="NewsItemImagePlaceholder" style="padding-top: ',
                          c += s.suppressValue(100 * s.memberLookup(f, "imageHeight") / s.memberLookup(f, "imageWidth"), t.opts.autoescape),
                          c += '%">\n                        ',
                          o = 12,
                          r = 36,
                          s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) ? (c += '\n                            <img src="',
                            c += s.suppressValue(s.memberLookup(f, "imageSmall"), t.opts.autoescape),
                            c += '">\n                        ') : (c += '\n                            <img src="',
                              c += s.suppressValue(s.memberLookup(f, "image"), t.opts.autoescape),
                              c += '">\n                        '),
                          c += "\n                        </div>\n                    </div>\n                ") : "Video" == s.memberLookup(f, "tp") && (c += '\n                    <div class="NewsItemVideo">\n                        <div class="NewsItemVideoWrapper">',
                            c += s.suppressValue(t.getFilter("safe").call(e, s.memberLookup(f, "videoOembed")), t.opts.autoescape),
                            c += "</div>\n                    </div>\n                "),
                      c += "\n            "
                  }
                n = n.pop(),
  ...
  , 17, 17, function (t, e, n) {
    (function (e) {
      ...
      t.exports = o.extend({
        ...
        activate: function () {
          return console.log("activate NewsSection"),
            this.options.server ? (this.state.offset = window.app.data.newsOffset,
              this.state.hasMore = window.app.data.newsHasMore) : (this.state.offset = this.data.news.length,
                this.state.hasMore = this.data.news.offset),
            e(window).on("scroll", this.handleParalax),
            this.recalcElementsPos(),
            this.options.server && this.handleParalax(),
            app.settings.isMobile || app.views.topNav.changeColor("white"),
            this.showImageLoader(),
            o.prototype.activate.call(this)
        },
        deactivate: function (t) {
          return e(window).off("scroll", this.handleParalax),
            o.prototype.deactivate.call(this, t)
        },
        ...
        handleParalax: function () {
          ...
          if (this.recalcElementsPos.__throttled(),
            !app.settings.isMobile && this.showItemsOnScroll)
            for (var s = this.itemsPos.length - 1; s >= 0; s--)
              !this.itemsPos[s].shown && this.itemsPos[s].top < t + n - 70 && (this.itemsPos[s].shown = !0,
                this.itemsPos[s].$item.removeClass("invisible"));
        ...
        onClickMoreButton: function () {
          ...
          this.forceLoadData(this.moreApi).then(function () {
            ...
            t.state.hasMore ? (t.$(".NewsList").append(n),
              t.recalcElementsPos(),
              setTimeout(t.handleParalax, 100),
              n.velocity({
                opacity: 1
              }, 500),
              t.showImageLoader()) : t.$(".NewsMoreButtonWrapper").velocity({
                opacity: 0
              }, 300, function () {
                e(this).remove(),
                  t.$(".NewsList").append(n),
          ...
          try {
            e.getSuper(t, "data", o, n, s, function (o, r) {
              return o ? void a(o) : (r = s.markSafe(r),
                i += "\n    ",
                i += s.suppressValue(r, t.opts.autoescape),
                i += "\n    window.app.data.newsOffset = ",
                i += s.suppressValue(t.getFilter("length").call(e, s.contextOrFrameLookup(e, n, "news")), t.opts.autoescape),
                i += ";\n    window.app.data.newsHasMore = ",
                i += s.suppressValue(t.getFilter("jsonify").call(e, s.contextOrFrameLookup(e, n, "hasMore")), t.opts.autoescape),
                i += ";\n",
                void a(null, i))
            })
          } catch (t) {
        ...
        t.exports = o.extend({
          ...
          initialize: function (t) {
            o.prototype.initialize.call(this, t),
              ...
              this.recalcOnScroll.__debounced = a.debounce(this.recalcOnScroll, 200),
              "info" == this.options.referrer ? (this.apiUrl = "/api/projects/all-info/",
                this.rootUrl = "/info/") : this.apiUrl = "/api/projects/all-work/",
              t.server && (this.$el.hide(),
                this.fixScrollBars(),
                this.$el.addClass("ProjectPopup--visible"),
                this.$el.addClass("ProjectPopup--scroll"),
                this.$el.outerHeight(),
                this.$el.show(),
                this.mobileTransformPopupToGlobalScroll(),
                e("html").addClass("HideGlobalScroll"),
                this.$(".ProjectPopupContent").scrollTop(0),
                this.recalcOnScroll(),
          ...
          onTouchStart: function (t) {
            app.settings.isTablet && (this.scrollY = t.originalEvent.touches.item(0).clientY,
              this.hasFingersOnScreen = !0,
              this.fixScrollPosition())
          },
          onTouchEnd: function (t) {
            if (app.settings.isTablet) {
              var e = t.originalEvent.touches;
              e.length && "touchcancel" != t.type || (this.hasFingersOnScreen = !1,
                this.fixScrollPosition())
            }
          },
          ...
          updateNextPanel: function () {
            this.$(".ProjectItemNext:not(.proceeded)").each(function (t, n) {
              var s, o = e(n), r = o.closest(".ProjectItem"), c = r.attr("data-id") - 0, i = a.findWhere(this.data, {
                uniqId: c
              }), l = a.findIndex(this.data, i), p = l == this.data.length - 1;
              o.toggle(!p).addClass("proceeded"),
                p || (s = app.utils.upperExcludeFirst(this.data[l + 1].title).replace(/\*/g, " "),
                  e(".ProjectItemNextTitle", o).text(s))
            }
              .bind(this))
          },
          renderProject: function (t) {
            ...
            return n.find(".ProjectItemBlocks").hide(),
              n
          },
          ...
          recalcOnScroll: function () {
            if (this.data && !this.preventScrollHandle) {
              var t, n, o, r, c, i = [], l = (e(window).width(),
                e(window).height()), p = app.settings.isMobile ? e(window) : this.$(".ProjectPopupContent"), u = p[0], d = p.scrollTop();
              if (this.$(".ProjectItem").each(function (t, n) {
                ...
                for (var h = !1, f = this.projectsPos.length - 1; f >= 0; f--)
                  if (app.settings.isMobile && !h && this.projectsPos[f].top - d <= 30 && (n = a.findWhere(this.data, {
                    ...
                    this.$(".ProjectPopupTitle").text(n.title.replace(/\*/g, " ")),
                    this.$(".ProjectPopupTitle").addClass("visible"),
                    h = !0),
                    this.projectsPos[f].top + (app.settings.isMobile ? -d : 0) < l / 2) {
                ...
                this.currentProject = n,
                  ...
                  app.settings.isDesktop && !c && u.scrollHeight - u.scrollTop == u.clientHeight && (clearTimeout(this.addProjectTimeout),
                    this.addProjectTimeout = setTimeout(function () {
                      this.preventScrollHandle = !0,
                        p.css("pointer-events", "none");
          ...
          adoptTitleAndTeaser: function (t) {
            if (t = t || {},
              clearTimeout(this.adoptTitleTimeout),
              !window.app.komissarLetterSizes) {
              ...
              e("body").append(o),
                ...
                o.remove(),
                r.W > 130 ? (this.adoptTitleRepeatCount = (this.adoptTitleRepeatCount || 0) + 1,
                  console.log("get font size iteration: ", this.adoptTitleRepeatCount),
                  this.adoptTitleTimeout = setTimeout(function () {
                    this.adoptTitleAndTeaser({
                      updateAll: !0
                    })
                  }
            ...
            this.$(".ProjectItemTitle" + (t.updateAll ? "" : ":not(.font-adopted)")).each(function () {
              function t(t) {
                var e, n = t.split(" "), s = 0, o = window.app.komissarLetterSizes, r = app.settings.isMobile ? window.innerHeight < window.innerWidth ? 39 : 62 : 140;
                return o ? (a.each(n, function (t, e) {
                  ...
                  e = Math.floor(200 * c / s) - 1,
                  e = Math.min(e, r)) : r
              }
              var n = e(this).text();
              c = c || e(this).width(),
                e(this).hasClass("font-adopted") || (n = n.replace(/(^| )(\W)($| )/g, " $2 "),
                  n = n.replace(/(^| )(\w{1,2}) /g, "$1$2 "),
                  n.split(" ").length > 3 && (n = n.replace(/(^| )(\w{3,3}) /g, "$1$2 ")),
                  n.split(" ").length > 3 && (n = n.replace(/(^| )(\w{4,4}) /g, "$1$2 ")),
                  n.split(" ").length > 3 && (n = n.replace(/(^| )(\w{5,5}) /g, "$1$2 ")),
                  n = n.replace(/^ +/g, ""),
                  n = n.replace(/ +$/g, ""),
                  n = n.replace(/( | )/g, " $1"),
                  e(this).html(n)),
          ...
          fixScrollBars: function () {
            app.settings.isMobile || (this.$(".ProjectPopupSidebar").css("right", app.utils.getScrollbarWidth()),
              this.$(".ProjectItem, .ProjectPopupBG").css("width", "calc(100vw - " + (120 + app.utils.getScrollbarWidth()) + "px)"))
          },
          ...
          mobileTransformPopupToLocalScroll: function () {
            app.settings.isMobile && (e(".Section-main, .TopNav, .Footer").css("top", "").removeClass("FixedOnPopup"),
              this.$el.removeClass("global-scroll"),
              e(window).scrollTop(this.savedScroll))
          },
          playIn: function (t) {
            var n = this;
            return this.fixScrollBars(),
          ...
          playOut: function (t) {
            ...
            return s.off("scroll", this.onScroll),
          ...
          viewsRegistration: function () { },
          destroy: function () {
            return e(window).off("resize", this.onResize),
              clearTimeout(this.adoptTitleTimeout),
              this.marker && this.marker.setMap(null),
              e("html").removeClass("HideGlobalScroll"),
              o.prototype.destroy.call(this)
          ...
          deactivate: function (t) {
            return clearTimeout(this.adoptTitleTimeout),
              e(window).off("resize", this.onResize),
              e("html").removeClass("HideGlobalScroll"),
              this.mobileTransformPopupToLocalScroll(),
              o.prototype.deactivate.call(this, t)
          }
        })
    }
                  ...
                  void t.getTemplate("front/pages/Projects/Project-inner.jinja", !1, "assets/app/front/pages/Projects/ProjectPopup.jinja", null, function (l, u) {
                    return l ? void a(l) : void u.render(e.getVariables(), n, function (l, u) {
                      return l ? void a(l) : (c += u,
                        ...
                        o = 14,
                        r = 14,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) && (c += '<div class="ProjectPopupTitle"></div>'),
                        ...
                        o = 18,
                        r = 15,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) && (c += '<div class="ProjectPopupShareIcon">',
                          c += s.suppressValue((o = 18,
                            r = 82,
                            s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["share", s.makeKeywordArgs({
                              caller: function () {
                          ...
                          c += "</div>"),
                        c += '\n\t\t\t<div class="ProjectPopupShareDropdown">\n\t\t\t\t<div class="ProjectPopupShareDropdownPinterest">',
                        c += s.suppressValue((o = 20,
                          r = 74,
                          s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["pinterest", s.makeKeywordArgs({
                            caller: function () {
                        ...
                        c += '</div>\n\t\t\t\t<div class="ProjectPopupShareDropdownFacebook">',
                        c += s.suppressValue((o = 21,
                          r = 73,
                          s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["facebook", s.makeKeywordArgs({
                            caller: function () {
                        ...
                        c += '</div>\n\t\t\t\t<div class="ProjectPopupShareDropdownTwitter">',
                        c += s.suppressValue((o = 22,
                          r = 72,
                          s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["twitter", s.makeKeywordArgs({
                            caller: function () {
                        ...
                        c += '</div>\n\t\t\t\t<div class="ProjectPopupShareDropdownTumblr">',
                        c += s.suppressValue((o = 23,
                          r = 71,
                          s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["tumblr", s.makeKeywordArgs({
                            caller: function () {
                        ...
                        o = 26,
                        r = 19,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isDesktop"), "isDesktop", e, [s.contextOrFrameLookup(e, n, "request")]) || (c += '<div class="ProjectPopupShareOverlay"></div>'),
                        c += "\n\n\t\t",
                        o = 28,
                        r = 18,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) || (c += '\n\t\t\t<a class="ProjectPopupNext InnerProjectLink hidden">',
                          c += s.suppressValue((o = 29,
                            r = 77,
                            s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["next", s.makeKeywordArgs({
                              caller: function () {
                          ...
                          c += '</a>\n\t\t\t<a class="ProjectPopupPrev InnerProjectLink hidden">',
                          c += s.suppressValue((o = 30,
                            r = 77,
                            s.callWrap(s.memberLookup(p, "svgSprite"), 'macros["svgSprite"]', e, ["prev", s.makeKeywordArgs({
                              caller: function () {
                ...
                e.setVariable("macros", p),
                  ...
                  s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) || (c += '\n            <div class="ProjectItemHeaderLeft">\n                 ',
                    s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "image") && (c += '\n                    <img class="ProjectItemImagePreloadOrder" src="',
                      c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "image"), t.opts.autoescape),
                      c += '">\n                    <div class="ProjectItemHeaderImageWrapper">\n                        <div class="ProjectItemHeaderImage" style="background-image:url(',
                      c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "image"), t.opts.autoescape),
                      c += ')"></div>\n                        <div class="ImageLoader ImageLoader--OnDarkBackground">\n                            <div class="ImageLoaderWhiteCircle"></div>\n                            <div class="ImageLoaderBlackCircle"></div>\n                        </div>\n                    </div>\n                '),
                    c += '\n                <div class="ProjectItemHeaderMap">\n                    <div class="ProjectItemHeaderMapWrapper" data-lat="',
                    c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "coordsLat"), t.opts.autoescape),
                    c += '" data-lng="',
                    c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "coordsLng"), t.opts.autoescape),
                    c += '"></div>\n                    <div class="ProjectItemHeaderMapPlace">',
                    c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "target"), t.opts.autoescape),
                    c += '</div>\n                    <div class="ProjectItemHeaderMapAddress">',
                    c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "fullAddress"), t.opts.autoescape),
                    c += "</div>\n                </div>\n            </div>\n        "),
                  ...
                  c += s.suppressValue((o = 40,
                    r = 67,
                    s.callWrap(s.contextOrFrameLookup(e, n, "upperExcludeFirst"), "upperExcludeFirst", e, [s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "title")])), t.opts.autoescape),
                  ...
                  o = 52,
                  r = 16,
                  s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) && s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "imageSmall") && (c += '\n        <div class="ProjectItemImagePlaceholder ProjectItemImageMobileCover" style="padding-top: ',
                    c += s.suppressValue(100 * s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "imageHeight") / s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "imageWidth"), t.opts.autoescape),
                    c += '%">\n            <img src="',
                    c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "imageSmall"), t.opts.autoescape),
                    c += '">\n            <div class="ImageLoader">\n                <div class="ImageLoaderWhiteCircle"></div>\n                <div class="ImageLoaderBlackCircle"></div>\n            </div>\n        </div>\n    '),
                ...
                if (d)
                  for (var h = d.length, f = 0; f < d.length; f++) {
                    ...
                    if (n.set("block", v),
                      ...
                      c += "\n                ";
                      var m;
                      if (m = t.getFilter("length").call(e, s.memberLookup(s.contextOrFrameLookup(e, n, "projectItem"), "related")) && 0 == s.contextOrFrameLookup(e, n, "relatedPrinted") && (o = 67,
                        r = 101,
                        !s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")])),
                        n.set("hasRelated", m, !0),
                        n.topLevel && e.setVariable("hasRelated", m),
                        n.topLevel && e.addExport("hasRelated", m),
                        c += '\n                <div class="ProjectItemText clearfix ',
                        s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "last") && (c += "LastItem"),
                        c += " ",
                        s.contextOrFrameLookup(e, n, "hasRelated") || (c += "NoRelated"),
                        c += '">\n                    <div class="ProjectItemTextColumnLeft">',
                        c += s.suppressValue(t.getFilter("safe").call(e, s.memberLookup(v, "text")), t.opts.autoescape),
                        c += '</div>\n                    <div class="ProjectItemTextColumnRight">',
                        c += s.suppressValue(t.getFilter("safe").call(e, s.memberLookup(v, "text2")), t.opts.autoescape),
                        c += "</div>\n                    ",
                      ...
                      "Img2" == s.memberLookup(v, "tp") ? (c += "\n                ",
                        o = 86,
                        r = 28,
                        s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) ? (c += '\n                    <div class="ProjectItemImgOne ',
                          s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "last") && (c += "LastItem"),
                          c += '">\n                        <div class="ProjectItemImagePlaceholder" style="padding-top: ',
                          c += s.suppressValue(100 * s.memberLookup(v, "imageHeight") / s.memberLookup(v, "imageWidth"), t.opts.autoescape),
                          c += '%">\n                            <img src="',
                          c += s.suppressValue(s.memberLookup(v, "imageSmall"), t.opts.autoescape),
                          c += '">\n                        </div>\n                    </div>\n                ') : (c += '\n                    <div class="ProjectItemImgOne ',
                            s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "last") && (c += "LastItem"),
                            c += '">\n                        <div class="ProjectItemImagePlaceholder" style="padding-top: ',
                            c += s.suppressValue(100 * s.memberLookup(v, "imageHeight") / s.memberLookup(v, "imageWidth"), t.opts.autoescape),
                            c += '%">\n                            <img src="',
                            c += s.suppressValue(s.memberLookup(v, "image"), t.opts.autoescape),
                            c += '">\n                        </div>\n                    </div>\n                '),
                        c += "\n            ") : "Img1" == s.memberLookup(v, "tp") ? (c += "\n                ",
                          ...
                          s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) ? (c += '\n                    <div class="ProjectItemImgOne ',
                            ...
                            s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "last") && (c += "LastItem"),
                            c += '">\n                        <div class="ProjectItemImagePlaceholder" style="padding-top: ',
                            c += s.suppressValue(100 * s.memberLookup(v, "image2Height") / s.memberLookup(v, "image2Width"), t.opts.autoescape),
                            c += '%">\n                            <img src="',
                            c += s.suppressValue(s.memberLookup(v, "image2Small"), t.opts.autoescape),
                            c += '">\n                        </div>\n                    </div>\n                ') : (c += "\n                    ",
                              s.memberLookup(v, "imageWidth") / s.memberLookup(v, "imageHeight") > s.memberLookup(v, "image2Width") / s.memberLookup(v, "image2Height") ? (c += '\n                        <div class="ProjectItemImgTwo ',
                                s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "last") && (c += "LastItem"),
                                c += '"><div class="ProjectItemImgTwoWrapper clearfix"><div class="ProjectItemImagePlaceholderWrapper" style="float:left"><div class="ProjectItemImagePlaceholder" style="padding-top: ',
                                c += s.suppressValue(100 * s.memberLookup(v, "imageHeight") / s.memberLookup(v, "imageWidth"), t.opts.autoescape),
                                c += '%"><img src="',
                                c += s.suppressValue(s.memberLookup(v, "imageMain"), t.opts.autoescape),
                                c += '"></div></div><span style="right: 0; background-image: url(',
                                c += s.suppressValue(s.memberLookup(v, "image2Main"), t.opts.autoescape),
                                c += ')"></span></div></div>\n                        <img class="ProjectItemImagePreloadOrder" src="',
                                c += s.suppressValue(s.memberLookup(v, "image2"), t.opts.autoescape),
                                c += '">\n                    ') : (c += '\n                        <img class="ProjectItemImagePreloadOrder" src="',
                                  c += s.suppressValue(s.memberLookup(v, "image"), t.opts.autoescape),
                                  c += '">\n                        <div class="ProjectItemImgTwo ',
                                  s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "last") && (c += "LastItem"),
                                  c += '"><div class="ProjectItemImgTwoWrapper clearfix"><span style="left: 0; background-image: url(',
                                  c += s.suppressValue(s.memberLookup(v, "imageMain"), t.opts.autoescape),
                                  c += ')"></span><div class="ProjectItemImagePlaceholderWrapper" style="float:right"><div class="ProjectItemImagePlaceholder" style="padding-top: ',
                                  c += s.suppressValue(100 * s.memberLookup(v, "image2Height") / s.memberLookup(v, "image2Width"), t.opts.autoescape),
                                  c += '%"><img src="',
                                  c += s.suppressValue(s.memberLookup(v, "image2Main"), t.opts.autoescape),
                                  c += '"></div></div></div></div>\n                    '),
                              c += "\n                "),
                          c += "\n            ") : "Video" == s.memberLookup(v, "tp") && (c += '\n                <div class="ProjectItemVideo ',
                            s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "last") && (c += "LastItem"),
                            c += '">\n                    <div class="ProjectItemVideoWrapper">',
                            c += s.suppressValue(t.getFilter("safe").call(e, s.memberLookup(v, "videoOembed")), t.opts.autoescape),
                            c += "</div>\n                </div>\n            ");
                    c += "\n        "
                  }
                n = n.pop(),
    ...
    (function (e) {
      ...
      n(80),
        t.exports = a.extend({
          ...
          activate: function (t) {
            return e(window).on("scroll", this.handleParalax),
              app.views.topNav.changeColor("black"),
              this.recalcElementsPos(),
              this.options.server && this.handleParalax(),
              this.showImageLoader(),
              a.prototype.activate.call(this, t)
          },
          deactivate: function (t) {
            return e(window).off("scroll", this.handleParalax),
              a.prototype.deactivate.call(this, t)
                ...
                if (i)
                  for (var l = i.length, p = 0; p < i.length; p++) {
                    ...
                    n.set("category", u),
                      ...
                      n.set("loop.length", l),
                      c += "\n                    ",
                      t.getFilter("length").call(e, s.memberLookup(u, "projects")) && (c += '\n                        <div class="ProjectsSidebarPoint"><span>',
                        c += s.suppressValue(s.memberLookup(u, "title"), t.opts.autoescape),
                        c += "</span></div>\n                    "),
                      c += "\n                "
                  }
                n = n.pop(),
                ...
                if (d)
                  for (var h = d.length, f = 0; f < d.length; f++) {
                    ...
                    n.set("category", v),
                      ...
                      n.set("loop.length", h),
                      c += "\n                            ",
                      t.getFilter("length").call(e, s.memberLookup(v, "projects")) && (c += '\n                                <div class="ProjectsQuickJumpPanelCategory">',
                        c += s.suppressValue(s.memberLookup(v, "title"), t.opts.autoescape),
                        c += "</div>\n                            "),
                      c += "\n                        "
                  }
                n = n.pop(),
              ...
              if (m)
                for (var g = m.length, w = 0; w < m.length; w++) {
                  ...
                  if (n.set("category", y),
                    ...
                    n.set("loop.index0", w),
                    n.set("loop.revindex", g - w),
                    n.set("loop.revindex0", g - w - 1),
                    n.set("loop.first", 0 === w),
                    n.set("loop.last", w === g - 1),
                    n.set("loop.length", g),
                    c += "\n                    ",
                    ...
                    if (b)
                      for (var k = b.length, M = 0; M < b.length; M++) {
                        var x = b[M];
                        if (n.set("p", x),
                          n.set("loop.index", M + 1),
                          n.set("loop.index0", M),
                          n.set("loop.revindex", k - M),
                          n.set("loop.revindex0", k - M - 1),
                          n.set("loop.first", 0 === M),
                          n.set("loop.last", M === k - 1),
                          n.set("loop.length", k),
                          c += '\n                                <div class="ProjectsListItem ',
                          o = 45,
                          r = 77,
                          s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) || (c += " invisible "),
                          c += '">\n                                     <a href="',
                          c += s.suppressValue(s.memberLookup(x, "link"), t.opts.autoescape),
                          c += '" class="u-Route" data-uniqId="',
                          c += s.suppressValue(s.memberLookup(x, "uniqId"), t.opts.autoescape),
                          c += '">\n                                        <div class="ProjectsListItemImage">\n                                            ',
                          s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "index0") % 6 == 0 ? (c += "\n                                                ",
                            o = 49,
                            r = 60,
                            s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) ? (c += '\n                                                    <img src="',
                              c += s.suppressValue(s.memberLookup(x, "previewImageV"), t.opts.autoescape),
                              c += '" alt="">\n                                                ') : (c += '\n                                                    <img src="',
                                c += s.suppressValue(s.memberLookup(x, "previewImageVHD"), t.opts.autoescape),
                                c += '" alt="">\n                                                '),
                            c += "\n                                            ") : s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "index0") % 6 == 1 || s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "index0") % 6 == 4 ? (c += '\n                                                <img src="',
                              ...
                              c += '" alt="">\n                                            ') : s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "index0") % 6 == 3 ? (c += "\n                                                ",
                                ...
                                r = 60,
                                s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]) ? (c += '\n                                                    <img src="',
                                  c += s.suppressValue(s.memberLookup(x, "previewImageH"), t.opts.autoescape),
                                  c += '" alt="">\n                                                ') : (c += '\n                                                    <img src="',
                                    c += s.suppressValue(s.memberLookup(x, "previewImageHHD"), t.opts.autoescape),
                                    c += '" alt="">\n                                                '),
                                c += "\n                                            ") : s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "index0") % 6 != 2 && s.memberLookup(s.contextOrFrameLookup(e, n, "loop"), "index0") % 6 != 5 || (c += '\n                                                <img src="',
                                  c += s.suppressValue(s.memberLookup(x, "previewImageH"), t.opts.autoescape),
                                  c += '" alt="">\n                                            '),
                          c += '\n                                            <div class="ImageLoader">\n                                                <div class="ImageLoaderWhiteCircle"></div>\n                                                <div class="ImageLoaderBlackCircle"></div>\n                                            </div>\n                                        </div>\n                                        <div class="ProjectsListItemTexts">\n                                            <div class="ProjectsListItemTextsCaption">',
                          c += s.suppressValue(t.getFilter("safe").call(e, t.getFilter("replace").call(e, s.memberLookup(x, "rawTitle"), "*", "<br/>")), t.opts.autoescape),
                          c += '</div>\n                                            <div class="ProjectsListItemTextsDesc">',
                          c += s.suppressValue(s.memberLookup(x, "city"), t.opts.autoescape),
                          s.memberLookup(x, "year") && (c += "<br>",
                            c += s.suppressValue(s.memberLookup(x, "year"), t.opts.autoescape)),
                          c += "</div>\n                                        </div>\n                                    </a>\n                                </div>\n\n                                ",
                          c += "\n                                ",
        ...
        t.exports = a.extend({
          ...
          onInstagramClick: function (t) {
            if (!app.settings.isDesktop) {
              ...
              n.hasClass("active") ? n.removeClass("active") : (n.addClass("active").siblings().removeClass("active"),
                t.preventDefault())
            }
          },
    ...
    (function (e) {
      ...
      t.exports = a.extend({
        ...
        changeColor: function (t) {
          app.settings.isMobile || (this.$(".TopNavLogo svg").css("fill", t),
            this.$(".TopNavLogoBurgerL").css("background", t))
        }
      })
    }
    ).call(e, n(4))
          ...
          try {
            ...
            t.getTemplate("front/utils/macros.jinja", !1, "assets/app/front/components/TopNav/TopNav.jinja", !1, function (l, p) {
              return l ? void a(l) : void p.getExported(function (l, p) {
                return l ? void a(l) : (e.setVariable("macros", p),
                  c += '\n\n<div class="TopNav ',
                  ("index" != s.contextOrFrameLookup(e, n, "pageType") || (o = 2,
                    r = 54,
                    s.callWrap(s.contextOrFrameLookup(e, n, "isMobile"), "isMobile", e, [s.contextOrFrameLookup(e, n, "request")]))) && (c += "visible"),
        ...
        onMainLinkHover: function (t) {
          if (app.settings.isDesktop) {
            var n = e(t.currentTarget)
              , s = n.find("svg.text")
              , a = s.clone();
            n.hasClass("animating") || (n.addClass("animating"),
              a.css("transform", "translateY(-98%)").appendTo(n).outerHeight(),
              a.css("transform", ""),
              s.css("transform", "translateY(98%)"),
              app.utils.waitForTransitionEnd(a, "transform", function () {
                s.remove(),
            ...
            t.getTemplate("front/utils/macros.jinja", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", !1, function (l, p) {
              return l ? void a(l) : void p.getExported(function (l, p) {
                return l ? void a(l) : (e.setVariable("macros", p),
                  ...
                  c += s.suppressValue((o = 4,
                    r = 18,
                    s.callWrap(s.contextOrFrameLookup(e, n, "url"), "url", e, ["sm:index", s.contextOrFrameLookup(e, n, "prodDomain")])), t.opts.autoescape),
                  c += '" class="u-Route home-link fast-navigate">',
                  void t.getTemplate("front/components/TopNav/bg.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                    return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                      return l ? void a(l) : (c += p,
                        void t.getTemplate("front/components/TopNav/home.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                          return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                            return l ? void a(l) : (c += p,
                              c += '</a>\n\t    <a href="',
                              c += s.suppressValue((o = 5,
                                r = 18,
                                s.callWrap(s.contextOrFrameLookup(e, n, "url"), "url", e, ["sm:index", s.contextOrFrameLookup(e, n, "prodDomain")])), t.opts.autoescape),
                              c += '" class="u-Route mobile-home-link fast-navigate">',
                              void t.getTemplate("front/components/TopNav/bg.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                                return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                  return l ? void a(l) : (c += p,
                                    void t.getTemplate("front/components/TopNav/home-mobile.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                                      return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                        return l ? void a(l) : (c += p,
                                          c += '</a>\n\t    <a href="',
                                          c += s.suppressValue((o = 6,
                                            r = 18,
                                            s.callWrap(s.contextOrFrameLookup(e, n, "url"), "url", e, ["sm:projects", s.contextOrFrameLookup(e, n, "prodDomain")])), t.opts.autoescape),
                                          c += '" class="u-Route work-link fast-navigate">',
                                          void t.getTemplate("front/components/TopNav/bg.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                                            return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                              return l ? void a(l) : (c += p,
                                                void t.getTemplate("front/components/TopNav/work.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                                                  return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                                    return l ? void a(l) : (c += p,
                                                      c += '</a>\n\t    <a href="',
                                                      c += s.suppressValue((o = 7,
                                                        r = 18,
                                                        s.callWrap(s.contextOrFrameLookup(e, n, "url"), "url", e, ["sm:news", s.contextOrFrameLookup(e, n, "prodDomain")])), t.opts.autoescape),
                                                      c += '" class="u-Route news-link fast-navigate">',
                                                      void t.getTemplate("front/components/TopNav/bg.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                                                        return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                                          return l ? void a(l) : (c += p,
                                                            void t.getTemplate("front/components/TopNav/news.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                                                              return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                                                return l ? void a(l) : (c += p,
                                                                  c += '</a>\n\t    <a href="',
                                                                  c += s.suppressValue((o = 8,
                                                                    r = 18,
                                                                    s.callWrap(s.contextOrFrameLookup(e, n, "url"), "url", e, ["sm:news", s.contextOrFrameLookup(e, n, "prodDomain")])), t.opts.autoescape),
                                                                  c += '" class="u-Route mobile-news-link fast-navigate">',
                                                                  void t.getTemplate("front/components/TopNav/bg.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                                                                    return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                                                      return l ? void a(l) : (c += p,
                                                                        void t.getTemplate("front/components/TopNav/news-mobile.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (l, p) {
                                                                          return l ? void a(l) : void p.render(e.getVariables(), n, function (l, p) {
                                                                            return l ? void a(l) : (c += p,
                                                                              c += '</a>\n\t    <a href="',
                                                                              c += s.suppressValue((o = 9,
                                                                                r = 18,
                                                                                s.callWrap(s.contextOrFrameLookup(e, n, "url"), "url", e, ["sm:info", s.contextOrFrameLookup(e, n, "prodDomain")])), t.opts.autoescape),
                                                                              c += '" class="u-Route info-link fast-navigate">',
                                                                              void t.getTemplate("front/components/TopNav/bg.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (o, r) {
                                                                                return o ? void a(o) : void r.render(e.getVariables(), n, function (o, r) {
                                                                                  return o ? void a(o) : (c += r,
                                                                                    void t.getTemplate("front/components/TopNav/info.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (o, r) {
                                                                                      return o ? void a(o) : void r.render(e.getVariables(), n, function (o, r) {
                                                                                        return o ? void a(o) : (c += r,
                                                                                          c += '</a>\n\t    <a href="',
                                                                                          c += s.suppressValue(s.memberLookup(s.contextOrFrameLookup(e, n, "shop"), "shopUrl"), t.opts.autoescape),
                                                                                          c += '" class="mobile-shop-link">',
                                                                                          void t.getTemplate("front/components/TopNav/bg.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (o, r) {
                                                                                            return o ? void a(o) : void r.render(e.getVariables(), n, function (o, r) {
                                                                                              return o ? void a(o) : (c += r,
                                                                                                void t.getTemplate("front/components/TopNav/shop.svg", !1, "assets/app/front/components/TopNav/TopNavPopup.jinja", null, function (o, r) {
                                                                                                  return o ? void a(o) : void r.render(e.getVariables(), n, function (o, r) {
                                                                                                    if (o)
                                                                                                      return void a(o);
                                                                                                    c += r,
