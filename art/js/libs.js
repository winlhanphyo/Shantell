!(function (t) {
  ...
  window.webpackJsonp = function (s, o) {
    for (var a, u, c = 0, l = []; c < s.length; c++)
      (u = s[c]), i[u] && l.push.apply(l, i[u]), (i[u] = 0);
    for (a in o)
    ...
    for (n && n(s, o); l.length; ) l.shift().call(null, e);
    if (o[0]) return (r[0] = 0), e(0);
  };
  var r = {},
    i = { 3: 0 };
  (e.e = function (t, n) {
    ...
    if (void 0 !== i[t]) i[t].push(n);
      ...
      (s.type = "text/javascript"),
        ...
        (s.src =
          e.p +
          "" +
          { 0: "cbc794e8e2c9c8f628f9", 2: "b43ab582e40ef52d4880" }[t] +
          ".js"),
        r.appendChild(s);
    }
  }),
  ...
  (function (t) {
        ...
        !(function (o) {
          ...
          var o,
            ...
            c = function (t, e, r, i, s) {
              ...
              if (r && "object" == typeof r) {
                ...
                for (o = r.split(u); a < o.length; a++) e = t(e, o[a], i, s);
              else e = t(e, r, i, s);
              return e;
            };
          (a.on = function (t, e, n) {
            if (
              ((this._events = c(l, this._events || {}, t, e, {
                context: n,
                ctx: this,
                listening: o,
              })),
          ...
          (a.off = function (t, e, n) {
            ...
            (a.stopListening = function (t, e, r) {
              ...
              if (!i) return this;
              for (
                var s = t ? [t._listenId] : n.keys(i), o = 0;
                o < s.length;
                o++
              ) {
                var a = i[s[o]];
          ...
          var f = function (t, e, r, i) {
            if (t) {
              ...
              if (e || o || r) {
                for (s = e ? [e] : n.keys(t); u < s.length; u++) {
                  ...
                  for (var l = [], h = 0; h < c.length; h++) {
                    var f = c[h];
                    if (
                      (r && r !== f.callback && r !== f.callback._callback) ||
                      (o && o !== f.context)
                    )
                      l.push(f);
                    else {
              ...
              for (s = n.keys(a); u < s.length; u++) a[s[u]].cleanup();
            }
          };
          ...
          a.trigger = function (t) {
            ...
            for (
              var e = Math.max(0, arguments.length - 1), n = Array(e), r = 0;
              r < e;
              r++
            )
              n[r] = arguments[r + 1];
          ...
          n.extend(m.prototype, a, {
            ...
            save: function (t, e, r) {
              ...
              null == t || "object" == typeof t
                ? ((i = t), (r = e))
                : ((i = {})[t] = e),
                (r = n.extend({ validate: !0, parse: !0 }, r));
              var s = r.wait;
              if (i && !s) {
            ...
            destroy: function (t) {
              ...
              return (
                this.isNew()
                  ? n.defer(t.success)
                  : (V(this, t), (o = this.sync("delete", this, t))),
                i || s(),
                o
              );
            },
          ...
          n.extend(y.prototype, a, {
            ...
            remove: function (t, e) {
              ...
              return (
                !e.silent &&
                  i.length &&
                  ((e.changes = { added: [], merged: [], removed: i }),
              ...
              if (null != t) {
                ...
                if (p) {
                  for (o = 0; o < this.length; o++)
                    (s = this.models[o]), h[s.cid] || l.push(s);
                ...
                if (
                  ...
                  (v || w) && this.trigger("sort", this, e),
                    (u.length || l.length || c.length) &&
                      ((e.changes = { added: u, removed: l, merged: c }),
                      this.trigger("update", this, e));
                }
                return r ? t[0] : t;
              }
        ...
        !(function () {
          ...
          (y.reduce = y.foldl = y.inject = O(1)),
            ...
            (y.every = y.all =
              function (t, e, n) {
                e = x(e, n);
                for (
                  var r = !T(t) && y.keys(t), i = (r || t).length, s = 0;
                  s < i;
                  s++
                ) {
                  var o = r ? r[s] : s;
            ...
            (y.invoke = w(function (t, e, n) {
              ...
              return (
                ...
                y.map(t, function (t) {
                  var s = i;
                  if (!s) {
                    if ((r && r.length && (t = j(t, r)), null == t)) return;
                    s = t[e];
                  }
          ...
          (y.flatten = function (t, e) {
              ...
              function (t, e, n, r) {
                ...
                for (var i = [], s = [], o = 0, a = I(t); o < a; o++) {
                  ...
                  e && !n
                    ? ((o && s === c) || i.push(u), (s = c))
                    : n
                    ? y.contains(s, c) || (s.push(c), i.push(u))
            ...
            (y.intersection = function (t) {
              for (
                var e = [], n = arguments.length, r = 0, i = I(t);
                r < i;
                r++
              ) {
                var s = t[r];
            ...
            (y.unzip = function (t) {
              for (
                var e = (t && y.max(t, I).length) || 0, n = Array(e), r = 0;
                r < e;
                r++
              )
                n[r] = y.pluck(t, r);
          ...
          var H = function (t, e, n) {
            return function (r, i, s) {
              ...
              if (i !== i)
                return (s = e(h.call(r, o, a), y.isNaN)), s >= 0 ? s + o : -1;
          ...
          (y.bind = w(function (t, e, n) {
            ...
            (y.memoize = function (t, e) {
              var n = function (r) {
                ...
                return A(i, s) || (i[s] = t.apply(this, arguments)), i[s];
              };
              return (n.cache = {}), n;
            }),
                  ...
                  return (
                    ...
                    l <= 0 || l > e
                      ? (r && (clearTimeout(r), (r = null)),
                        ...
                        (o = t.apply(i, s)),
                        r || (i = s = null))
                      : r || n.trailing === !1 || (r = setTimeout(u, l)),
                    o
                  );
                };
              return (
          ...
          (y.keys = function (t) {
            ...
            (y.values = function (t) {
              for (
                var e = y.keys(t), n = e.length, r = Array(n), i = 0;
                i < n;
                i++
              )
                r[i] = t[e[i]];
          ...
          (y.pick = w(function (t, e) {
            ...
            if (null == t) return n;
            y.isFunction(r)
              ? (e.length > 1 && (r = _(r, e[1])), (e = y.allKeys(t)))
              : ((r = U), (e = P(e, !1, !1)), (t = Object(t)));
            ...
            (y.omit = w(function (t, e) {
              ...
              return (
                y.isFunction(r)
                  ? ((r = y.negate(r)), e.length > 1 && (n = e[1]))
                  : ((e = y.map(P(e, !1, !1), String)),
                    (r = function (t, n) {
          ...
          (q = function (t, e, n, r) {
            ...
            (L = function (t, e, n, r) {
              ...
              if ((n.push(t), r.push(e), s)) {
                ...
                for (; u--; ) if (!q(t[u], e[u], n, r)) return !1;
              } else {
                var l,
                  h = y.keys(t);
                if (((u = h.length), y.keys(e).length !== u)) return !1;
                for (; u--; )
                  if (((l = h[u]), !A(e, l) || !q(t[l], e[l], n, r))) return !1;
              }
          ...
          (y.escape = K(D)),
            ...
            (y.result = function (t, e, n) {
              y.isArray(e) || (e = [e]);
              var r = e.length;
              if (!r) return y.isFunction(n) ? n.call(t) : n;
              for (var i = 0; i < r; i++) {
            ...
            return (
              y.each(y.functions(t), function (e) {
                ...
                y.prototype[e] = function () {
                  var t = [this._wrapped];
                  return l.apply(t, arguments), Z(this, n.apply(y, t));
                };
              }),
              y
            );
    ...
    function (t, e, n) {
      ...
      !(function (n, s) {
        ...
        /*! svg4everybody v2.1.9 | github.com/jonathantneal/svg4everybody */ function t(
          t,
          e,
          n
        ) {
        ...
        function n(n) {
          function i() {
            for (var n = 0; n < p.length; ) {
              ...
              if (
                (!l && o.attributeName && (l = a.getAttribute(o.attributeName)),
                c && l)
              ) {
                if (s)
                  if (!o.validate || o.validate(l, c, a)) {
                    ...
                    if (g.length) {
                      var y = f[g];
                      y ||
                        ((y = f[g] = new XMLHttpRequest()),
                        y.open("GET", g),
                        y.send(),
                        (y._embeds = [])),
                        y._embeds.push({ parent: u, svg: c, id: m }),
                        e(y);
                    } else t(u, c, document.getElementById(m));
                  } else ++n, ++v;
              } else ++n;
            }
